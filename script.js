...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const Personalization = {
        ...
        init() {
            ...
            const company = rawCompany ? `${rawCompany} | Albañilería` : null;
            const name = rawName ? `${rawName} | Albañil` : null;
        ...
        apply({ type, value }) {
            // Update page title
            document.title = `${value} | Servicio de Albañilería`;
            ...
            document.querySelectorAll('[data-dynamic]').forEach(el => {
                ...
                switch (key) {
                    ...
                    case 'footer-name':
                        ...
                        break;
                    case 'title':
                        el.textContent = `${value} | Servicio de Albañilería`;
                        break;
                }
            });
        ...
        updateMeta(name) {
            ...
            if (meta) {
                meta.content = `${name} - Servicio profesional de albañilería. Muros, revoques, pisos y reparaciones. Garantía en todos los trabajos.`;
            }
        }
    };
